...
-->
	...
	<![endif]-->
                        ...
                        <div class="col-md-8 col-sm-6 col-xs-2">
                            <div class="main-menu">
                                <ul class="visible-lg visible-md">
                                    ...
                                    <li><a href="addChangeBookPage.php">Admin</a></li>
                                </ul>
		...
		<script text="text/javascript">
			...
			$("li a").each(function(ind, el){
				if( $(el).attr("href") == document.location.pathname.replace(/\/(.+)\//g, "") )
					$(el.parentElement).addClass("active");
			});
			if($(".active").length == 0) 
				$("li a[href='index.php']").each(function(ind, el){
					$(el.parentElement).addClass("active");
				});
